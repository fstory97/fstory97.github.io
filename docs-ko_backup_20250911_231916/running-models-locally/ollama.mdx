---
title: "Ollama"
description: "Cline과 함께 로컬 AI 모델 실행을 위한 Ollama 설정에 대한 빠른 가이드입니다."
---
...
더 많은 정보가 필요하세요? [Ollama 문서](https://github.com/ollama/ollama/blob/main/docs/api.md)를 읽어보세요.
