---
title: "IAM 認証情報"
sidebarTitle: "IAM 認証情報"
description: "IAM アクセスキーとシークレットキー認証情報を使用して AWS Bedrock を Cline でセットアップします。確立された IAM ポリシーを持つ企業環境に最適です。"
---
...
-   **企業向け:** このガイドは、安全でコンプライアンスに準拠した使用を確実にするために、確立された AWS 環境（IAM ロール、AWS SSO、AWS Organizations などを使用）を持つ組織向けです。
