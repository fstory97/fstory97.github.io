---
title: "MCP 개요"
description: "MCP(Model Context Protocol) 서버, 기능 및 Cline이 이를 구축하고 사용하는 데 어떻게 도움이 되는지 알아보십시오. MCP는 애플리케이션이 LLM에 컨텍스트를 제공하는 방식을 표준화하여 AI 애플리케이션을 위한 USB-C 포트처럼 작동합니다."
---

## 빠른 링크

-   [GitHub에서 MCP 서버 구축](/mcp/adding-mcp-servers-from-github)
-   [처음부터 사용자 지정 MCP 서버 구축](/mcp/mcp-server-development-protocol)
...
-   **MCP 호스트**는 연결된 서버의 기능을 검색하고 도구, 프롬프트 및 리소스를 로드합니다.
...
-   **커뮤니티 저장소:** GitHub에서 커뮤니티에서 유지 관리하는 MCP 서버 목록을 확인하십시오. [GitHub에서 MCP 서버 추가](/mcp/adding-mcp-servers-from-github) 참조
-   **Cline 마켓플레이스:** Cline의 [MCP 마켓플레이스](/mcp/mcp-marketplace)에서 설치하십시오.
-   **Cline에게 문의:** Cline에게 MCP 서버를 찾거나 생성하는 데 도움을 요청할 수 있습니다.
-   **직접 구축:** [MCP SDK](https://github.com/modelcontextprotocol/)를 사용하여 사용자 지정 MCP 서버를 생성하십시오.
...
-   **YouTube 튜토리얼 (AI 기반 코더):** MCP 서버 구축 및 사용에 대한 비디오 가이드: [https://www.youtube.com/watch?v=b5pqTNiuuJg](https://www.youtube.com/watch?v=b5pqTNiuuJg)
