...
有关最新的实现细节，您可以在 [Cline 仓库](https://github.com/cline/cline/blob/main/src/core/Cline.ts)中查看完整的源代码。
...
3. **MCP 工具**
    ...
    - 用户可以创建 Cline 随后可以访问的自定义 MCP 工具
    - 示例：创建一个 Cline 可以用来获取天气预报的天气 API 工具
