		...
		<>
			...
			<a
				...
				<div style={{ display: "flex", gap: "12px" }}>
					...
					{item.logoUrl && (
						<img
							alt={t("mcpMarketplaceCard.logoAlt", "chat", { name: item.name })}
							src={item.logoUrl}
							style={{
								width: 42,
								height: 42,
						...
						<div
							...
							<div
								...
								<StyledInstallButton $isInstalled={isInstalled} disabled={isInstalled || isDownloading}>
									{isInstalled
										? t("mcpMarketplaceCard.installed", "chat")
										: isDownloading
											? t("mcpMarketplaceCard.installing", "chat")
											: t("mcpMarketplaceCard.install", "chat")}
								</StyledInstallButton>
							</div>
						</div>
						...
						<div
							...
							{item.requiresApiKey && (
								<span
									...
									style={{ flexShrink: 0 }}
									title={t("mcpMarketplaceCard.requiresApiKey", "chat")}
								/>
							)}
						</div>
					</div>
				...
				<div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
					{!item.isRecommended && (
						<div
							...
							<span>{t("mcpMarketplaceCard.communityMadeWarning", "chat")}</span>
						</div>
					)}
