...
| 功能 | 说明 | 文档 |
|------|------|------|
| **f01** | **通用工具库** | 共享工具函数和助手 | [📖 详情](../../caret-docs/features/f01-common-util.mdx) |
| **f02** | **多语言i18n** | 4语言支持（中/韩/日/英） | [📖 详情](../../caret-docs/features/f02-multilingual-i18n.mdx) |
| **f03** | **品牌与UI系统** | 动态品牌切换（Caret/Cline） | [📖 详情](../../caret-docs/features/f03-branding-ui.mdx) |
| **f04** | **Caret账户系统** | 用户认证与管理 | [📖 详情](../../caret-docs/features/f04-caret-account.mdx) |
| **f05** | **规则优先级系统** | 多层规则配置系统 | [📖 详情](../../caret-docs/features/f05-rule-priority-system.mdx) |
| **f06** | **JSON动态系统提示** | 灵活的提示管理 | [📖 详情](../../caret-docs/features/f06-json-system-prompt.mdx) |
| **f07** | **聊天机器人/代理模式** | 双重交互模式 | [📖 详情](../../caret-docs/features/f07-chatbot-agent.mdx) |
| **f08** | **角色系统** | 可定制的AI伙伴 | [📖 详情](../../caret-docs/features/f08-persona-system.mdx) |
| **f09** | **功能配置系统** | 模块化功能管理 | [📖 详情](../../caret-docs/features/f09-feature-config-system.mdx) |
| **f10** | **LiteLLM模型获取** | 实时模型发现 | [📖 详情](../../caret-docs/features/f10-litellm-model-fetching.mdx) |
| **f11** | **输入历史系统** | 终端风格命令历史 | [📖 详情](../../caret-docs/features/f11-input-history-system.mdx) |

</div>

→ **[查看完整功能索引](../../caret-docs/features/index.mdx)**
