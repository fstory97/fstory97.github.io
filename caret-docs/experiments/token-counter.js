...
console.log(`Character reduction: ${markdownContent.length - jsonContent.length} chars (${((markdownContent.length - jsonContent.length) / markdownContent.length * 100).toFixed(1)}% savings)`);