...
│   ├── CaretWebviewLogger.ts       # Webview logging system 
│   └── i18n.ts                # Translation & link integration utility (to be added)
├── locale/                    # Multilingual JSON files (to be added)
│   ├── ko/welcome.json        # Korean translation (with template variables)
│   ├── en/welcome.json        # English translation
│   ├── ja/welcome.json        # Japanese translation
│   └── zh/welcome.json        # Chinese translation
└── components/                # Caret components (to be added)
...
- [Caret Internationalization (i18n) Guide](../../features/f02-multilingual-i18n.md)
