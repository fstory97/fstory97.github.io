...
| 機能 | 説明 | ドキュメント |
|------|------|-------------|
| **f01** | **共通ユーティリティ** | 共有ユーティリティ関数とヘルパー | [📖 詳細](../../caret-docs/features/f01-common-util.mdx) |
| **f02** | **多言語i18n** | 4言語サポート（日/韓/英/中） | [📖 詳細](../../caret-docs/features/f02-multilingual-i18n.mdx) |
| **f03** | **ブランディング & UIシステム** | 動的ブランド切り替え（Caret/Cline） | [📖 詳細](../../caret-docs/features/f03-branding-ui.mdx) |
| **f04** | **Caretアカウントシステム** | ユーザー認証と管理 | [📖 詳細](../../caret-docs/features/f04-caret-account.mdx) |
| **f05** | **ルール優先順位システム** | 多層ルール構成システム | [📖 詳細](../../caret-docs/features/f05-rule-priority-system.mdx) |
| **f06** | **JSON動的システムプロンプト** | 柔軟なプロンプト管理 | [📖 詳細](../../caret-docs/features/f06-json-system-prompt.mdx) |
| **f07** | **チャットボット/エージェントモード** | 二重インタラクションモード | [📖 詳細](../../caret-docs/features/f07-chatbot-agent.mdx) |
| **f08** | **ペルソナシステム** | カスタマイズ可能なAIコンパニオン | [📖 詳細](../../caret-docs/features/f08-persona-system.mdx) |
| **f09** | **機能設定システム** | モジュラー機能管理 | [📖 詳細](../../caret-docs/features/f09-feature-config-system.mdx) |
| **f10** | **LiteLLMモデル取得** | リアルタイムモデル発見 | [📖 詳細](../../caret-docs/features/f10-litellm-model-fetching.mdx) |
| **f11** | **入力履歴システム** | ターミナル風コマンド履歴 | [📖 詳細](../../caret-docs/features/f11-input-history-system.mdx) |

</div>

→ **[完全な機能インデックスを見る](../../caret-docs/features/index.mdx)**
